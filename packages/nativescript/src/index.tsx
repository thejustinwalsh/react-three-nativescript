...
export { createCanvasPage, runThreeFiberApp, type CanvasAppProps, type PageOptions, type StatsOptions } from './app'
...
// directly on a ready event instead of using runThreeFiberApp/createCanvasPage).
// The high-level APIs (runThreeFiberApp, createCanvasPage) + polyfills side-effects now fully
